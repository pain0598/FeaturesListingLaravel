            ...
            <div class="col-lg-3">
                <div class="dashboard_sidebar">
                    ...
                    <ul class="dashboard_link">
                        <li><a  href="{{route('renter-dashboard')}}"><i class="fas fa-tachometer" aria-hidden="true"></i>Dashboard</a></li>
                        <li><a href="{{ route('my-favorites') }}"><i class="far fa-heart" aria-hidden="true"></i> My Favorites </a></li>
                        <li><a class="active" href="{{ route('notes-messages') }}"><i class="far fa-comments-alt" aria-hidden="true"></i> Message</a></li>
